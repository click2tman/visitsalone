    ...
    attach: function (context, settings) {
      $(context).find('.mt-carousel-articles').once('mtOwlCarouselArticlesInit').each(function() {
        $(this).owlCarousel({
          ...
          autoplay: drupalSettings.visitsalone.owlCarouselArticlesInit.owlArticlesAutoPlay,
          autoplayTimeout: drupalSettings.visitsalone.owlCarouselArticlesInit.owlArticlesEffectTime,
          nav: true,
          dots: true,
          loop: true,
