    ...
    attach: function (context, settings) {
      $(context).find('.tp-carousel-products').once('mtowlCarouselProductsInit').each(function() {
        $(this).owlCarousel({
          ...
          autoplay: drupalSettings.visitsalone.owlCarouselProductsInit.owlProductsAutoPlay,
          autoplayTimeout: drupalSettings.visitsalone.owlCarouselProductsInit.owlProductsEffectTime,
          nav: true,
          dots: false,
          loop: true,
