jQuery(document).ready(function($) {
  ...
  filtersMasonry.prepend( "<li class=\"active\"><a href=\"#\" data-filter=\"*\">" + drupalSettings.visitsalone.isotopeFiltersGridInit.isotopeFiltersText + "</a></li>" );
  ...
  masonryContainer.imagesLoaded(function() {
    masonryContainer.isotope({
      ...
      layoutMode : drupalSettings.visitsalone.isotopeFiltersGridInit.isotopeLayoutMode,
