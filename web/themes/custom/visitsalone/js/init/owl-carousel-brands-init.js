    ...
    attach: function (context, settings) {
      $(context).find('.mt-carousel-brands').once('mtowlCarouselBrandsInit').each(function() {
        $(this).owlCarousel({
          ...
          autoplay: drupalSettings.visitsalone.owlCarouselBrandsInit.owlBrandsAutoPlay,
          autoplayTimeout: drupalSettings.visitsalone.owlCarouselBrandsInit.owlBrandsEffectTime,
          nav: true,
          dots: false,
          loop: true,
