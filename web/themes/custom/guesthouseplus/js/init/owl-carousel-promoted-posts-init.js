    ...
    attach: function (context, settings) {
      $(context).find('.mt-carousel-promoted-posts').once('mtowlCarouselPromotedPostsInit').each(function() {
        $(this).owlCarousel({
          ...
          autoplay: drupalSettings.guesthouseplus.owlCarouselPromotedPostsInit.owlPromotedPostsAutoPlay,
          autoplayTimeout: drupalSettings.guesthouseplus.owlCarouselPromotedPostsInit.owlPromotedPostsEffectTime,
          nav: true,
          dots: false,
          loop: true,
