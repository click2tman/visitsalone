jQuery(document).ready(function($) {
  ...
  filtersMasonry.prepend( "<li class=\"active\"><a href=\"#\" data-filter=\"*\">" + drupalSettings.guesthouseplus.isotopeFiltersGridInit.isotopeFiltersText + "</a></li>" );
  ...
  masonryContainer.imagesLoaded(function() {
    masonryContainer.isotope({
      ...
      layoutMode : drupalSettings.guesthouseplus.isotopeFiltersGridInit.isotopeLayoutMode,
